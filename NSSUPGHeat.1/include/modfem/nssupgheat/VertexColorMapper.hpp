...
///@todo rename to PaletteColorMapper or IndexColorMapper.
class MODFEM_NSSUPGHEAT_API VertexColorMapper:
	public QObject
{
		Q_OBJECT
	...
	public:
		...
		Q_PROPERTY(QVariantList map READ map WRITE setMap NOTIFY mapChanged)	///@todo Rename to palette.

		Q_PROPERTY(QByteArray colorIndices READ colorIndices WRITE setColorIndices NOTIFY colorIndicesChanged)	///@todo Rename to input.

		Q_PROPERTY(QByteArray colorVertices READ colorVertices NOTIFY colorVerticesChanged)	///@todo Rename to output.
