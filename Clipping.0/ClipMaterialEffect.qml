...
//                    annotations: Annotation { name: "pass"; value: "material" }
					shaderProgram: ShaderProgram {
						vertexShaderCode: loadSource("shaders/gl3/phong-clip.vert")
						fragmentShaderCode: loadSource("shaders/gl3/phong-clip.frag")
                    }
                },
...
//                    annotations: Annotation { name: "pass"; value: "stencilFill" }
                    shaderProgram: ShaderProgram {
						vertexShaderCode: loadSource("shaders/gl3/phong-clip.vert")
						fragmentShaderCode: loadSource("shaders/gl3/passthrough.frag")
                    }
                }
            ]
        }
