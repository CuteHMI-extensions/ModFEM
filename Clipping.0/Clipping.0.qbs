...
Project {
	...
	cutehmi.Extension {
		...
		files: [
         ...
         "shaders/gl3/capping.frag",
         "shaders/gl3/capping.geom",
         "shaders/gl3/capping.vert",
         "shaders/gl3/passthrough.frag",
         "shaders/gl3/phong-clip.frag",
         "shaders/gl3/phong-clip.vert",
